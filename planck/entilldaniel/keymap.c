...
const uint32_t unicode_map[] PROGMEM = {
  [U_ARING_LOWER] = 0x00e5,
  [U_ARING_UPPER] = 0x00c5,
  [U_AAUML_LOWER] = 0x00e4,
  [U_AAUML_UPPER] = 0x00c4,
  [U_OAUML_LOWER] = 0x00f6,
  [U_OAUML_UPPER] = 0x00d6,
};

# define U_ARING UP(U_ARING_LOWER, U_ARING_UPPER)
# define U_AAUML UP(U_AAUML_LOWER, U_AAUML_UPPER)
# define U_OAUML UP(U_OAUML_LOWER, U_OAUML_UPPER)
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, NUMS   , _______, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_ADJUST] = LAYOUT_planck_grid(
    QK_UNICODE_MODE_EMACS, QK_UNICODE_MODE_LINUX, _______, _______, _______, _______, _______, _______, U_ARING, U_AAUML, U_OAUML, _______,
...
[_ARROWS] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, NUMS   , _______, _______, NUMS   , _______, _______, _______, KC_END
),
...
[_NUMS] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, KC_0   , _______, KC_PSLS, _______
),
